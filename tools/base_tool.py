...
Every tool in AeroCut AI by MCR inherits from BaseTool. This enforces a uniform
...
class BaseTool(ABC):
    """Abstract base class for all AeroCut AI by MCR tools."""
