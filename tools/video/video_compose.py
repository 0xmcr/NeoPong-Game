...
class VideoCompose(BaseTool):
        ...
        "properties": {
            "operation": {
                ...
                "description": (
                    ...
                    "for images/animations or FFmpeg for video-only. Preferred for mcr-compose-director. "
    ...
    def _render(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        This is the primary entry point for the mcr-compose-director skill.
        ...
        if render_result.success and output_path.exists():
            ...
            # Attach final_review to the ToolResult data so the mcr-compose-director
