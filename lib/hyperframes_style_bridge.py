"""Bridge AeroCut AI by MCR playbooks → HyperFrames-friendly style artifacts.

AeroCut AI by MCR playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by AeroCut AI by MCR HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
