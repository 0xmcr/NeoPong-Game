...
SECTIONS = [
    ...
    ("s4_climax",  "Climax", 38, 50, "This is not science fiction. AeroCut AI by MCR is an open-source platform that orchestrates AI tools into a complete video pipeline."),
    ...
    "entries": [
        {
            ...
            "metadata_used": {
                ...
                "hashtags": ["#AI", "#VideoProduction", "#AeroCut AI by MCR"],
                "chapters": [
                    {"time": "0:00", "label": "Hook"},
                    {"time": "0:08", "label": "The Problem"},
                    {"time": "0:20", "label": "The Solution"},
                    {"time": "0:38", "label": "AeroCut AI by MCR"},
