...
class TestCapabilityMetadata:
    ...
    def test_registry_catalog_views(self):
        ...
        assert providers == {"elevenlabs", "google_tts", "openai", "piper", "doubao"}
...
class TestSkillsExist:
    ...
    @pytest.mark.parametrize("skill_path", [
        "pipelines/explainer/mcr-idea-director.md",
        "pipelines/explainer/mcr-script-director.md",
        "pipelines/explainer/mcr-scene-director.md",
        "pipelines/explainer/mcr-asset-director.md",
        "pipelines/explainer/mcr-edit-director.md",
        "pipelines/explainer/mcr-compose-director.md",
        "pipelines/explainer/mcr-publish-director.md",
    ])
