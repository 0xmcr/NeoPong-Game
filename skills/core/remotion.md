...
**This file** teaches how AeroCut AI by MCR uses Remotion — which compositions map to pipeline
...
| AeroCut AI by MCR Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| AeroCut AI by MCR Profile | Remotion Config |
|--------------------|-----------------|
...
to ALL pipelines, not just explainer. Pipeline-specific mcr-compose-directors may extend it but
