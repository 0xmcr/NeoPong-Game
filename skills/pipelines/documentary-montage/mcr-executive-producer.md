# MCR Executive Producer - Documentary Montage Pipeline
...
|-------|----------------|----------|
| `idea` | `mcr-idea-director.md` | brief (topic, tone, duration, shape) |
| `scene` | `mcr-scene-director.md` | shot_list (slot descriptions + queries) |
| `assets` | `mcr-asset-director.md` | asset_manifest (corpus built + per-slot picks) |
| `edit` | `mcr-edit-director.md` | edit_decisions (timeline + transitions + music) |
| `compose` | `mcr-compose-director.md` | render_report (final mp4) |
