# MCR Proposal Director - Character Animation Pipeline
...
When both Remotion and hyperframes are available, you must present both options to the user before locking render_runtime. Record the choice as a render_runtime_selection in the log.
