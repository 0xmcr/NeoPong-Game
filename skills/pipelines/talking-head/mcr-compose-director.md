# MCR Compose Director — Talking Head Pipeline
...
3. **Auto-build corrections dictionary** from common ASR error patterns:
   ...
   corrections = {
       ...
       "open montage": "AeroCut AI by MCR",
       "remotion": "Remotion",
...
4. **Green screen flag** -- Check if mcr-scene-director Step 0 flagged green/blue screen footage. If yes, note that Step 3c (Green Screen Composite) will be needed.
...
**Overlay type → required props** (same as mcr-asset-director mapping):
...
If the footage has a green/blue screen (detected in mcr-scene-director Step 0), follow this pipeline:
