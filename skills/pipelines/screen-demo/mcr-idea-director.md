# MCR Idea Director - Screen Demo Pipeline
...
**Record the mode in `brief.metadata.production_mode`.** The mcr-asset-director reads this field to choose between capture+overlay assets vs a `steps` list paced with narration.
