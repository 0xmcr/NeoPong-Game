# MCR Script Director — Animation Pipeline
...
| Prior artifact | `proposal_packet` from MCR Proposal Director | Selected concept, animation mode, target duration, reuse strategy |
| Optional artifact | `research_brief` from MCR Research Director | Data points, audience insights, accuracy constraints |
