# Scene Detection Usage for AeroCut AI by MCR
...
- Good default for AeroCut AI by MCR explainers where Manim segments are static but live-action may have motion
