# ManimCE Usage for AeroCut AI by MCR
...
## Render Settings for AeroCut AI by MCR
...
For AeroCut AI by MCR's YouTube landscape profile (1920x1080/30fps), render at `-qh` and transcode to 30fps, or set custom config:
