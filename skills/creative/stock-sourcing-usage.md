# Stock Sourcing Usage for AeroCut AI by MCR
...
The MCR Edit Director and MCR Compose Director treat stock assets identically to generated ones — they just reference the file path from the manifest.
...
Both are safe for all AeroCut AI by MCR use cases. No licensing fees, no per-use royalties, no attribution obligations.
